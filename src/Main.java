import entidades.*;
//import org.example.entidades.*; // asi como lo puse el profe no me lo toma nose por que????. ES POR QUE NO TENGO EL PAQUETE ORG.EXAMPLE
//import org.example.repositorios.InMemoryRepository;// ESE FUE EL ERROR
...
public class Main {
    public static void main(String[] args) {
        ...
        Empresa empresa1 = Empresa.builder()
                ...
                .cuil(12345678901L)
                .sucursales(new HashSet<>(Set.of(sucursal1, sucursal2)))//empresa1 relacionada con sucursal 1 y 2
                .build();
